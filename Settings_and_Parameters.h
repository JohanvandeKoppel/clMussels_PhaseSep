...
#define Beta        1.89;            // 1.89 - The non-parameterical density-dependence parameter
#define k1          0.1;             // 0.1  - The non-local diffusion term

#define Time		1                // 1     Start time of the simulation
#define dT          0.1              // 0.1   TIME STEP
...
#define EndTime		20000            // 20000  End time of the simulation
